			...
			<div class="auth-form px-3" id="login">
				...
				<!-- </textarea></xmp> -->
					...
					<div class="auth-form-body mt-3">
						...
						<h2 for="Success Message">更新失败</h2></div><br/>
						<div  style="text-align:center">
						<a href="http://localhost:8080/LiveRoomWeb/updateUserInfo">重新更新</a>
						<a href="http://localhost:8080/LiveRoomWeb/UserInfo">返回个人信息</a>
						</div>
					</div>
					</div>
